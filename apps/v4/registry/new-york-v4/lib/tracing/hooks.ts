...
import type { ComponentStatusCode, InteractionType } from "./types"
  ...
  return useCallback(
    (operationName: string) => {
      ...
      return {
        ...
        end: (statusCode: ComponentStatusCode = ComponentStatus.OK) =>
          operation.end(statusCode),
      }
    },
    [componentName]
  )
